      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 text-sm">
            <div class="site-info">
              <a href="#"><span class="mai-call text-primary"></span> +016673528</a>
              <span class="divider">|</span>
              <a href="www.email.com"><span class="mai-mail text-primary"></span> mail@example.com</a>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupport">
          <ul class="navbar-nav ml-auto">
            ...
            @auth 
            <li class="nav-item">
              <a class="nav-link" style="background-color:greenyellow;" href="{{url('myappointment')}}">My Appoinments</a>
            </li>
  ...
  <div align="center" style="padding:100px;">
    <table>
        ...
        <tr style="background-color:blue;" align="center">
            ...
            <td style="padding:20px;  color:white;"><a class="bt btn-danger" onclick="return confirm('are you sure to delete')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel</a></td>
        </tr>
        @endforeach
    </table>
  </div>
